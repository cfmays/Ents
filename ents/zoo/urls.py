...
urlpatterns = [
    ...
    path('training/manage/print/', views.training_master_list_print, name='training_master_list_print'),
    path('calendars/manage/', views.manage_calendars, name='manage_calendars'),
